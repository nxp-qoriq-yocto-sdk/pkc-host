...
static void report_ccb_status(struct device *jrdev, const uint32_t status,
			      const char *error)
{
...
static void report_jump_status(struct device *jrdev, const uint32_t status,
			       const char *error)
{
...
static void report_deco_status(struct device *jrdev, const uint32_t status,
			       const char *error)
{
...
static void report_jr_status(struct device *jrdev, const uint32_t status,
			     const char *error)
{
	dev_err(jrdev, "%08x: %s: %s() not implemented\n",
		status, error, __func__);
...
static void report_cond_code_status(struct device *jrdev, const uint32_t status,
				    const char *error)
{
	dev_err(jrdev, "%08x: %s: %s() not implemented\n",
		status, error, __func__);
...
void sec_jr_strstatus(struct device *jrdev, uint32_t status)
{
	static const struct stat_src {
		void (*report_ssed)(struct device *jrdev, const uint32_t status,
				    const char *error);
		const char *error;
	} status_src[16] = {
		{ NULL, "No error" },
